        ...
        (function() {
            ...
            function getCssFiles() {
                ...
                var cssCollection = [
                        'http://localhost:8000/capture/css/main-winner.css'
                    ];
            ...
            function getJsFiles() {
                ...
                var jsCollection = [
                        'http://localhost:8000/js_modules/winner/ouibounce.js',
                        'http://localhost:8000/js_modules/winner/exit-intent.js',
                        'http://localhost:8000/js_modules/winner/capture.js',
                        'http://localhost:8000/js_modules/winner/footer.js'
                    ];
